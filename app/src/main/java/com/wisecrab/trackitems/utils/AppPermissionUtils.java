package com.wisecrab.trackitems.utils;
...
import com.wisecrab.trackitems.helpers.DialogUtils;
...
public class AppPermissionUtils {
    ...
    public static void showLocationRational(Activity activity) {
        showRational(activity,ACCESS_FINE_LOCATION, R.string.permission_location_rational);
    }
}
